...
static const dm_range_t dm_range_table[] = {
    ...
    [DM_4310_48V] = { 12.5f, 45.0f, 18.0f },
    [DM_4340]     = { 12.5f, 30.0f, 27.0f },
    [DM_3519]     = { 12.5f, 20.0f,  8.0f },
    [DM_8006]     = { 12.5f, 21.0f, 20.0f },
    [DM_8009]     = { 12.5f, 18.0f, 40.0f },
    [DM_CUSTOM]   = { 12.5f, 30.0f, 10.0f },  /* 默认, 用户可覆盖 */
};
