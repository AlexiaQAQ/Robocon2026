...
#define SDA_4_Pin GPIO_PIN_4
#define SDA_4_GPIO_Port GPIOA
#define SCL_4_Pin GPIO_PIN_5
#define SCL_4_GPIO_Port GPIOA
#define SDA_3_Pin GPIO_PIN_6
#define SDA_3_GPIO_Port GPIOA
#define SCL_3_Pin GPIO_PIN_7
#define SCL_3_GPIO_Port GPIOA
